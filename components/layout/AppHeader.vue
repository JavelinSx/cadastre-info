  ...
  <header class="bg-gray-50 shadow-sm sticky top-0 z-101 flex justify-center">
    <div class="container-custom py-4 px-4 lg:px-8">
      <div class="flex justify-between items-center">
        <!-- Логотип слева -->
        <NuxtLink to="/" class="flex-shrink-0 flex items-center transition-transform duration-300 hover:scale-105">
          <img :src="logo" class="text-primary-600 w-8 h-8" />
          <span class="text-xl text-primary-600">ПлесКад</span>
        </NuxtLink>
