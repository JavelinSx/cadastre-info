...
import { topographicSurveyData } from '~/utils/data/services/geodesic/geodesic-topography';

definePageMeta({
  title: 'Топографическая съемка - Профессиональные геодезические услуги',
  description: 'Профессиональные услуги по топографической съемке местности для создания точных планов территории с отображением рельефа и всех объектов',
});

// Используем данные из файла
const serviceData = ref(topographicSurveyData);
</script>
