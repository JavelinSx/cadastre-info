<!-- pages/services/geodesic/geodesic-basis.vue -->
<template>
  ...
  import { geodesicBasisData } from '~/utils/data/services/geodesic/geodesic-basis';
  
  definePageMeta({
    title: 'Подготовка разбивочной основы - Геодезические услуги',
    description: 'Профессиональные услуги по созданию разбивочной основы для строительных работ, обеспечивающей точное положение конструкций в пространстве',
  });
  
  // Используем данные из файла
  const serviceData = ref(geodesicBasisData);
  </script>
