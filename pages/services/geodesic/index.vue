...
import { geodesicData } from '~/utils/data/services/geodesic/geodesic-data';

definePageMeta({
  title: 'Геодезические работы - Профессиональные услуги',
  description: 'Профессиональные геодезические работы: топографическая съемка, вынос границ в натуру, координирование объектов и другие виды геодезических изысканий',
});

// Используем данные из файла
const serviceData = ref(geodesicData);
</script>
