...
import { geodesicSurveysData } from '~/utils/data/services/geodesic/geodesic-surveys';

definePageMeta({
    title: 'Инженерно-геодезические изыскания - Профессиональные услуги',
    description: 'Комплексные инженерно-геодезические работы: топографическая съемка, геодезический мониторинг, разбивка осей, создание опорных сетей и другие услуги с гарантией точности.'
});

// Используем данные из файла
const serviceData = ref(geodesicSurveysData);
</script>
