...
import { boundaryStakeoutData } from '~/utils/data/services/geodesic/geodesic-boundary';

definePageMeta({
  title: 'Вынос границ земельного участка в натуру - Профессиональные услуги',
  description: 'Профессиональные услуги по выносу границ земельного участка в натуру с закреплением границ на местности и составлением акта выноса'
});

// Используем данные из файла
const serviceData = ref(boundaryStakeoutData);
</script>
