...
import { executiveSurveyData } from '~/utils/data/services/geodesic/geodesic-executive';

definePageMeta({
  title: 'Исполнительная съемка - Профессиональные геодезические услуги',
  description: 'Профессиональные услуги по проведению исполнительной съемки объектов строительства и инженерных коммуникаций с подготовкой всей необходимой документации'
});

// Используем данные из файла
const serviceData = ref(executiveSurveyData);
</script>
