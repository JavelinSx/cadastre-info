...
import { technicalPlanConstructionData } from '~/utils/data/services/technical-plans/construction';

definePageMeta({
    title: 'Технический план сооружения - Услуги кадастрового инженера',
    description: 'Профессиональная подготовка технического плана сооружений любого типа и сложности для кадастрового учета и регистрации права собственности'
});

// Используем данные напрямую
const serviceData = ref(technicalPlanConstructionData);
</script>
