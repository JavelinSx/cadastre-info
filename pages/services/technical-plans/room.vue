...
import { technicalPlanRoomData } from '~/utils/data/services/technical-plans/room';

definePageMeta({
    title: 'Технический план помещения - Услуги кадастрового инженера',
    description: 'Профессиональная подготовка технического плана помещения для оформления кадастрового учета и регистрации права собственности'
});

// Используем данные из файла
const serviceData = ref(technicalPlanRoomData);
</script>
