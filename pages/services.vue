<template>
  <div class=" py-16  min-h-[calc(100vh-200px)] flex items-center text-gray-800">
    <div class="container-custom">
      <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-8" v-motion :initial="{ opacity: 0, y: 20 }"
          ...
          <h1 class="text-3xl font-bold mb-4 animate-fadeIn" style="animation-delay: 300ms">Услуги</h1>
...
definePageMeta({
  title: 'Услуги - Страница в разработке',
