    ...
    <div class="container-custom">
      <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-8" v-motion :initial="{ opacity: 0, y: 20 }"
          ...
          <h1 class="text-3xl font-bold mb-4 animate-fadeIn" style="animation-delay: 300ms">Контакты</h1>
...
definePageMeta({
  title: 'Контакты - Страница в разработке',
  description: 'Наши контактные данные и адреса офисов'
});
</script>
